...
class ClientPrefs {
	...
	public static var noteSplashSelector:String = 'noteSplash2';
	...
	public static function saveSettings() {
		...
		FlxG.save.data.noteSplashSelector = noteSplashSelector;
	...
	public static function loadPrefs() {
		...
		if (FlxG.save.data.noteSplashSelector != null){
			noteSplashSelector = FlxG.save.data.noteSplashSelector;
		}
